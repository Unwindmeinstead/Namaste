export const translations = {
  ne: {
    ...
    googleSheetsDesc: 'डाटालाई स्प्रेडशीटमा निर्यात गर्नुहोस्',
    ...
    fullBackup: 'सबै डाटाको पूर्ण ब्याकअप',
    emailBackup: 'ईमेल ब्याकअप',
    emailBackupDesc: 'Gmail मा ब्याकअप पठाउनुहोस्',
    sendToEmail: 'ईमेलमा पठाउनुहोस्',
    openGmail: 'Gmail खुल्छ',
    localBackup: 'स्थानीय ब्याकअप',
    downloadBackup: 'ब्याकअप डाउनलोड गर्नुहोस्',
    saveToDevice: 'यन्त्रमा सुरक्षित गर्नुहोस्',
    csvDownloaded: 'CSV डाउनलोड भयो! नयाँ Google Sheet मा आयात गर्नुहोस्',
    backupDownloaded: 'ब्याकअप डाउनलोड भयो! Google Drive मा अपलोड गर्नुहोस्',
    enterEmail: 'कृपया आफ्नो ईमेल ठेगाना प्रविष्ट गर्नुहोस्',
    emailOpened: 'Gmail खुल्यो! ब्याकअप सुरक्षित गर्न ईमेल पठाउनुहोस्',
    ...
    totalMiles: 'कुल माइल',
    totalMilesDriven: 'कुल माइल यात्रा',
    irsDeduction: 'IRS कटौती',
    tripsLogged: 'यात्राहरू दर्ता',
    ...
    avgIncome: 'औसत आम्दानी',
    avgExpense: 'औसत खर्च',
    incomeBySource: 'स्रोत अनुसार आम्दानी',
    incomeSummary: 'आम्दानी सारांश',
    avgPerEntry: 'प्रति प्रविष्टि औसत',
    uniqueSources: 'अद्वितीय स्रोतहरू',
    expensesByCategory: 'श्रेणी अनुसार खर्च',
    noExpensesYet: 'अहिलेसम्म कुनै खर्च छैन',
    mileageTracking: 'माइलेज ट्र्याकिङ',
    ...
    about: 'बारेमा',
    helpGuide: 'प्रयोगकर्ता गाइड',
    helpGuideDesc: 'दक्षिणा कसरी प्रयोग गर्ने सिक्नुहोस्',
    version: 'संस्करण',
  ...
  en: {
    ...
    // Backup
    googleSheets: 'Google Sheets',
    googleSheetsDesc: 'Export your data as spreadsheets',
    exportTransactions: 'Transactions',
    exportSchedule: 'Schedule',
    services: 'services',
    googleDrive: 'Google Drive',
    googleDriveDesc: 'Save complete backup to your Drive',
    saveToDrive: 'Save to Drive',
    fullBackup: 'Full backup with all data',
    emailBackup: 'Email Backup',
    emailBackupDesc: 'Send backup to your Gmail',
    sendToEmail: 'Send to Email',
    openGmail: 'Opens Gmail to send',
    localBackup: 'Local Backup',
    downloadBackup: 'Download Backup',
    saveToDevice: 'Save to your device',
    csvDownloaded: 'CSV downloaded! Import it in the new Google Sheet',
    backupDownloaded: 'Backup downloaded! Upload it to your Google Drive',
    enterEmail: 'Please enter your email address',
    emailOpened: 'Gmail opened! Send the email to save your backup',
  ...
  hi: {
    ...
    // Backup
    googleSheets: 'Google Sheets',
    googleSheetsDesc: 'डेटा को स्प्रेडशीट में निर्यात करें',
    exportTransactions: 'लेन-देन',
    exportSchedule: 'शेड्यूल',
    services: 'सेवाएं',
    googleDrive: 'Google Drive',
    googleDriveDesc: 'पूर्ण बैकअप Drive में सहेजें',
    saveToDrive: 'Drive में सहेजें',
    fullBackup: 'सभी डेटा का पूर्ण बैकअप',
    emailBackup: 'ईमेल बैकअप',
    emailBackupDesc: 'Gmail पर बैकअप भेजें',
    sendToEmail: 'ईमेल पर भेजें',
    openGmail: 'Gmail खुलेगा',
    localBackup: 'लोकल बैकअप',
    downloadBackup: 'बैकअप डाउनलोड करें',
    saveToDevice: 'डिवाइस में सहेजें',
    csvDownloaded: 'CSV डाउनलोड हुआ! नई Google Sheet में आयात करें',
    backupDownloaded: 'बैकअप डाउनलोड हुआ! Google Drive में अपलोड करें',
    ...
    totalMiles: 'कुल मील',
    totalMilesDriven: 'कुल मील यात्रा',
    irsDeduction: 'IRS कटौती',
    tripsLogged: 'यात्राएं दर्ज',
    ...
    avgIncome: 'औसत आय',
    avgExpense: 'औसत व्यय',
    incomeBySource: 'स्रोत के अनुसार आय',
    incomeSummary: 'आय सारांश',
    avgPerEntry: 'प्रति प्रविष्टि औसत',
    uniqueSources: 'अद्वितीय स्रोत',
    expensesByCategory: 'श्रेणी के अनुसार व्यय',
    noExpensesYet: 'अभी तक कोई व्यय नहीं',
    ...
    about: 'के बारे में',
    helpGuide: 'उपयोगकर्ता गाइड',
    helpGuideDesc: 'दक्षिणा का उपयोग कैसे करें सीखें',
    version: 'संस्करण',
