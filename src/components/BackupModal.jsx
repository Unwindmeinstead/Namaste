...
export function BackupModal({ isOpen, onClose, entries, scheduledServices, settings, profile }) {
  ...
  const handleOpenInSheets = (type) => {
    ...
    const title = type === 'entries' ? 'Guruji_Transactions' : 'Guruji_Schedule'
  ...
  const handleEmailBackup = () => {
    ...
    const subject = encodeURIComponent(`Guruji Backup - ${new Date().toLocaleDateString()}`)
    const body = encodeURIComponent(`
Guruji Income Tracker Backup
=============================
